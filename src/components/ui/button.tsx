  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-bg text-white hover:shadow-glow transform hover:scale-105 font-bold text-lg shadow-elegant",
        cta: "gradient-bg text-white hover:shadow-glow transform hover:scale-105 font-bold shadow-elegant",
        "outline-white": "border-2 border-white text-white hover:bg-white hover:text-primary font-bold",
      },
      size: {
        default: "h-10 px-4 py-2",
        sm: "h-9 rounded-md px-3",
        lg: "h-12 rounded-xl px-8 py-3",
        xl: "h-14 rounded-xl px-12 py-5 text-xl",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
